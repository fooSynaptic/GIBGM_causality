...
library(snpStats)
#frpdir<-"C:/Users/jiajia/Documents/R/win-library/3.3/GeneGeneInteR/extdata/"
#ped<-"C:/Users/jiajia/Documents/R/win-library/3.3/GeneGeneInteR/extdata/inter.ped"
ped = paste(dir_path,'inter.ped',sep = '/')
snpinfo<-read.table(ped,header = F)
#info <-"C:/Users/jiajia/Documents/R/win-library/3.3/GeneGeneInteR/extdata/inter.info"
...
#posi <-"C:/Users/jiajia/Documents/R/win-library/3.3/GeneGeneInteR/extdata/inter.txt"
...
#write.csv(newmap,'c:/Users/jiajia/Desktop/??????ϵ????/sorteddata/newmap.csv',row.names = F)


#we want get the snp info
{
  #casesnp<-read.csv('c:/Users/jiajia/Desktop/??????ϵ????/newfrge/case.csv')
  casesnp = read.csv(paste(dir_path, 'case.csv', sep = '/'))
  casesnp$X.3<-rep(1,dim(casesnp)[1])
  #ctrlsnp<-read.csv('c:/Users/jiajia/Desktop/??????ϵ????/newfrge/control.csv')
  ...
  #source('c:/Users/jiajia/Desktop/??????ϵ????/newcasuality/recode_minor_Freq.R')
...
snpm$IID<-snpm$FID
#write.csv(snpm,'c:/Users/jiajia/Desktop/??????ϵ????/newfrge/snpm.csv',row.names = F)
...
#genebed<-read.csv('c:/Users/jiajia/Desktop/??????ϵ????/newfrge/mapfile.csv')
...
#save 
#write.csv(newglst,'c:/Users/jiajia/Desktop/??????ϵ????/sorteddata/newglst.csv',row.names = F)
...
#newpheno<-read.csv('c:/Users/jiajia/Desktop/??????ϵ????/newfrge/')

#load the gene and position information
#gene_info<-read.csv('c:/Users/jiajia/Desktop/??????ϵ????/sorteddata/gene_info.csv')
gene_info = read.csv(paste(dir_path, 'gene_info.csv',sep = '/'))

#formercase<-read.csv('c:/Users/jiajia/Desktop/??????ϵ????/sorteddata/finalsnpm.csv')
...
#newglst<-read.csv('c:/Users/jiajia/Desktop/??????ϵ????/sorteddata/newglst.csv')
#newgeno<-read.csv('c:/Users/jiajia/Desktop/??????ϵ????/newfrge/snpm.csv')
...
#write.csv(geno_expn,'c:/Users/jiajia/Desktop/??????ϵ????/sorteddata/expanded_genotype.csv',
#          row.names = F)
